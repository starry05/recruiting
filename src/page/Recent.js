        ...
        <Stack   mt='-35%' pl='10%'>
          ...
          <Box  w='80%' h='max-content' p="5%"  bg='rgba(255,255,255,0.5)'  borderRadius='xl' boxShadow='lg'>
             ...
             <List class="class-bo" spacing={2}  textAlign='left' position='relative'  fontSize='2xl' lineHeight='taller' >
                  <ListItem>
                    <ListIcon as={AiFillTool} color='purple.600' />
                      <Highlight
                        query='VSC extension'
                  ...
                  <ListItem>
                    <ListIcon as={AiFillCarryOut} color='purple.600' />
                      <Highlight
                        query='服务稳定性提升'
                        styles={{ px: '2', py: '1', rounded: 'full', bg: 'rgb(171, 130 ,255,0.2)' ,color:'black'}}>
                        服务稳定性提升
                  ...
                  <ListItem>
                    <ListIcon as={AiFillTags} color='purple.600' />
                      <Highlight
                        query='新前端'
                        styles={{ px: '2', py: '1', rounded: 'full', bg: 'rgb(171, 130 ,255,0.2)' ,color:'black'}}>
                        新前端
                  ...
                  <ListItem>
                  <ListIcon as={AiFillBulb} color='purple.600' />
                      <Highlight
                        query='服务端静态化重构'
                        styles={{ px: '2', py: '1', rounded: 'full', bg: 'rgb(171, 130 ,255,0.2)' ,color:'black'}}>
                        服务端静态化重构
